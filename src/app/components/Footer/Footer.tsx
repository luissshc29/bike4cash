...
export default function Footer() {
  return (
    <footer className="bottom-0 absolute flex justify-center items-center gap-2 lg:col-span-2 py-6 w-full text-neutral-700 text-xs md:text-sm [mix-blend-mode:multiply] z-[100]">
      ...
      <a href="https://www.instagram.com/luissshc_/" target="_blank" rel="noreferrer">
        <AiOutlineInstagram />
      </a>
      <a
